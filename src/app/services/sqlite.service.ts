...
import { CapacitorSQLite, CapacitorSQLitePlugin, capSQLiteResult, capSQLiteUpgradeOptions, capSQLiteValues, SQLiteConnection, SQLiteDBConnection } from '@capacitor-community/sqlite';
